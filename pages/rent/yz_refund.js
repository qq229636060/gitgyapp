    ...
    var refund = new Vue({
        ...
        methods: {
            submitrefund: function submitrefund() {
                ...
                console.log(costarr);
                bui.ajax({
                    url: apiUrl + "/mapi/owner/returnSave",
                    data: {
                        rent_id: rentid,
                        id: htid,
                        type: that.tztype,
        ...
        mounted: function mounted() {
            ...
            bui.ajax({
                ...
                console.log(result);
                if (result.code == 0) {
                    that.refundhousename = result.data.rent.title;
                    that.refundusename = result.data.owner.name;
                    that.tel = result.data.owner.mobile;
                    that.btime = result.data.owner.start_time;
                    that.etime = result.data.owner.end_time;
                    that.nowtime = result.data.owner.end_time;
                    that.datas.zujin = result.data.owner.rent;
                    that.datas.yajin = result.data.owner.deposit;
                    ...
                    that.payinfo = payarr;
                    times = result.data.owner.end_time.replace(/-/g, '/');
