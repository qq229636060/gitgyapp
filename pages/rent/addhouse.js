...
loader.define(function (require, exports, module) {
    ...
    var jzpub_tj = [];
    var havepub = [];
    var getinfos = function getinfos(housename, houseadder, quid, bkid, cityid, houseid) {
        bui.ajax({
    ...
    var addhousez = new Vue({
        ...
        methods: {
            goto_sohouse: function goto_sohouse() {
                if (this.citys == '-1') {
                    bui.alert("请选择城市");
                } else {
