loader.define(function (require, exports, module) {
    ...
    var denglu = function denglu(xhr) {xhr.setRequestHeader('token', islogin);xhr.setRequestHeader('clientid', 'testclient');};
    ...
    var contractlist = new Vue({
        ...
        methods: {
            ...
            hoverinfo: function hoverinfo(e, zq) {
                router.load({ url: "pages/rent/moneyinfo.html", param: { id: e, zq: zq } });
            }
